...
using SecuredWebApp.Infrastructure.Alerts;
...
namespace SecuredWebApp.Controllers
{
    ...
    public class AccountController : AppBaseController
    {
        ...
        public AccountController(AppDbContext dbContext, ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            if (result == SignInStatus.Success && AuthorizationProvider.NoRoleAssignment())
            {
                Helpers.Notification.SendAssignRoleNotice(loginInfo.Email);
            }
