...
using SecuredWebApp.Infrastructure.ModelMetadata;
using SecuredWebApp.Helpers;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(SecuredWebApp.StructureMapConfig), "Configure")]
    ...
    public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
                ...
                cfg.AddRegistry(new AppActionFilterRegistry(namespacePrefix: AppConstants.APP_ASSEMBLY_PREFIX));
